...
# mycursor.execute("CREATE TABLE off(marque VARCHAR(200), nom VARCHAR(200), nutriscore VARCHAR(5), store VARCHAR(200), category VARCHAR(20),code_id BIGINT, productID int PRIMARY KEY AUTO_INCREMENT)")

mycursor.execute("SHOW columns FROM off")
