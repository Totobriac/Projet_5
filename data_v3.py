...
bottom_menu= "Appuyez sur N pour consulter la page suivante, B la page precedente, \nM pour revenir au menu principal, \nC au menu des categories ou l'indice pour choisir ce produit: "

dotted_line= "---------------------------------------------------------------------------------------------------------------------------------------------------"

healthy_list_menu_text="Appuyez sur M pour revenir au menu principal, l'indice pour choisir ce produit \nou E pour effacer cette liste: "
...
healthy_item_menu_text="Appuyez sur M pour revenir au menu, A pour revenir a la liste des subsituts, \nO pour consulter sa fiche sur OpenFoodFact.org, \nS pour savoir ou l'acheter. "   